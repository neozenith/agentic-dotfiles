...
```sh
bun run .claude/skills/mermaidjs-diagrams/scripts/mermaid_contrast.ts   .claude/skills/refactor/README.md
bun run .claude/skills/mermaidjs-diagrams/scripts/mermaid_complexity.ts .claude/skills/refactor/README.md
