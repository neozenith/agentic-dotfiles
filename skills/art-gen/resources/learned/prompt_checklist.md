...
### 16. Never grant permission for geometry to leave the frame
...
### 17. A reserved empty region must be described as empty background, not as a named region
...
### 18. Dark grounds invite glow and transparency — demand opacity explicitly
