...
```bash
bun run .claude/skills/mermaidjs-diagrams/scripts/mermaid_complexity.ts \
  .claude/skills/mermaidjs-diagrams/resources/examples/test_complexity_recommend.md
```
