...
See also [../../claude_skills/index.md](../../claude_skills/index.md) when the script lives under `.claude/skills/*/scripts/` (merged Python + TypeScript conventions, also covers mixed-language skills).
...
- [../../claude_skills/index.md](../../claude_skills/index.md) — Merged Python + TypeScript conventions for scripts inside `.claude/skills/*/scripts/`. Use when writing **TypeScript scripts that are part of a Claude skill** (also covers mixed-language skills).
