...
- [../../claude_skills/index.md](../../claude_skills/index.md) — Merged Python + TypeScript conventions for scripts inside `.claude/skills/*/scripts/`. Use when writing **Python scripts that are part of a Claude skill** (also covers mixed-language skills).
