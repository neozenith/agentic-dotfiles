...
| `color.border.bold` | <span style="display:inline-block;width:38px;height:16px;border-radius:3px;vertical-align:middle;border:1px solid #8886;background:#868686"></span> `#868686` | <span style="display:inline-block;width:38px;height:16px;border-radius:3px;vertical-align:middle;border:1px solid #8886;background:#636363"></span> `#636363` | reference + offset toward text |
