...
The stopping rule is settled by DT-CONTRAST-1: imputed values are pushed until every text pairing
passes within its own tier, and stated values are never pushed. Contrast severity follows
